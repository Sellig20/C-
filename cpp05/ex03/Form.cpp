...
{
    o << "NAME = " << source.getName() << std::endl;
	o << "IS SIGNED = " << source.getIsSigned() << std::endl;
	o << "GRADE SIGN = " << source.getSignGrade() << std::endl;
	o << "EXECUTE GRADE = " << source.getExecuteGrade() << std::endl;
    return (o);
}
